	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($catalog) {
				...
				// Style Configuration
				$style_configuration = array();

				if ($this->user->hasPermission('access', 'extension/module/style_configuration')) {
					$style_configuration[] = array(
				...
				if ($this->user->hasPermission('access', 'extension/module/style_configuration')) {
					$style_configuration[] = array(
						'name'	   => $this->language->get('text_font'),
				...
				if ($style_configuration) {
					$data['menus'][] = array(
						'id'       => 'menu-style_configuration',
						'icon'	   => 'fa fa-cog fw',
						'name'	   => $this->language->get('text_style_configuration'),
						'href'     => '',
						'children' => $style_configuration
					);
				}
